...
mac() {
  cd "$root"
  xcodegen generate
  xcodebuild -project PhotosFork.xcodeproj -scheme PhotosFork-macOS -destination 'platform=macOS' -skipPackagePluginValidation CODE_SIGNING_ALLOWED=NO build test
}
