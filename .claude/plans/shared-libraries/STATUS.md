...
| T0 | Test harness: fixtures, world, disk oracle, runner, coverage | S0 (parallel-safe with S6/S7) | med | 🟨 | 83f7fc363 | verifier PARTIAL: harness runs, 16 missing IDs are untagged S6/S7/S8a specs (backfill); HOST unit PASS 15-Sep (111 files, 2388 passed + 1 pre-existing it.fails in timeline ctrl); watch-mode hang fixed in 727b68e38; medium/e2e-api/coverage still need host run |
